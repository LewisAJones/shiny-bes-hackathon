      ...
      nav_panel("About",
                tags$div(
                  ...
                  tags$div(
                    ...
                    span("If you have any comments or questions about this Shiny App, or face any difficulties while using the App, contact:", tags$a("Lewis.Jones@ucl.ac.uk", href = "mailto:Lewis.Jones@ucl.ac.uk"))
                  ),
                  tags$div(
                    class = "about-sidebar",
                    tags$figure(
                    ...
                    img(src = "bes-logo.svg", class = "img-invert",
                        style="max-width: 100%; height: auto; padding-top: 10%; padding-left: 20%; padding-right: 20%",
