  ...
  tagList(
    ...
    page_navbar(id = "tabs",
      ...
      nav_panel("About",
                ...
                p("Cooper et al., 2025. Data- and code-archiving in the British Ecological Society journals: present status and recommendations for future improvements. EcoEvoRxiv. https://doi.org/10.32942/X26W9V"),
                strong("Contributors"),
