      ...
      nav_panel("About",
                tags$div(
                  ...
                  tags$div(
                    ...
                    tags$div(
                      tags$span(
                        "If you have any comments or questions about this Shiny App, or face any difficulties while using the App, contact:", 
                        tags$a(
                          "Lewis.Jones@ucl.ac.uk", href = "mailto:Lewis.Jones@ucl.ac.uk"
                          )
                        )
                    )
                  ),
